...
public class DynamicMapSyncScheduler implements Scheduler {

    private final AtomicInteger taskCounter = new AtomicInteger();
    private final ScheduledExecutorService service;
    private final Map<Integer, ScheduledTask> scheduledTasks = new ConcurrentHashMap<>();

    public DynamicMapSyncScheduler(int threadPoolSize) {
        service = Executors.newScheduledThreadPool(threadPoolSize, new DynamicMapSyncThreadFactory());
    }
