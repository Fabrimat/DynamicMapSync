package me.fabrimat.dynamicmapsync.log;
...
public class DynamicMapSyncLogger extends Logger {
    private final LogDispatcher dispatcher = new LogDispatcher(this);

    public DynamicMapSyncLogger(String loggerName, String filePattern, ConsoleReader reader) {
